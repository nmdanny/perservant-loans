...
personApp cfg = serve (Proxy :: Proxy PersonAPI) (readerServerPerson cfg)


-- | This functions tells Servant how to run the 'App' monad with our
-- 'server' function.
readerServerPerson :: Config -> Server PersonAPI
readerServerPerson cfg = enter (convertApp cfg) personServer

readerServerLoan :: Config -> Server LoanAPI
readerServerLoan   cfg = enter (convertApp cfg) loanServer
...
-- always succeeds.
type AppAPI = PersonAPI :<|> LoanAPI :<|> Raw
...
app cfg =
    serve appApi (readerServerPerson cfg :<|> readerServerLoan cfg:<|> files)
